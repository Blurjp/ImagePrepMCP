...
export class JSXElementBuilder {
    ...
    buildProps(node, classes) {
        ...
        // Add src for images
        if (node.type === "IMAGE" && node.fills?.[0]?.type === "IMAGE") {
 ...
 */
export function jsxToString(element, indent = 0) {
 ...
 */
export function formatJSXForComponent(element, indent = 2) {
